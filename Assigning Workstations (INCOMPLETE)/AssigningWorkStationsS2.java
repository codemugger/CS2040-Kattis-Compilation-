...
public class AssigningWorkstationsS2{
    ...
    public static void main(String[] args) throws IOException{
        ...
        ArrayList<Integer> doneTimeList = new ArrayList<Integer>();
        ...
        for (int i = 1; i <= numberOfResearchers; i++){
            ...
            doneTimeList.add(researcherObject.getLeaveTime()); // add the done time a.k.a individuals leave time to queue 
        ...
        for (int i = 1 ; i <= numberOfResearchers; i++){
            ...
            // if not the first researcher who arrived, since that one confirmed need to unlock right? 
                ...
                int doneTime = doneTimeList.get(0); // get the arrival time (leftmost in chronological order)
